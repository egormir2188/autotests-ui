...
class CourseViewComponent(BaseComponent):
    ...
    def check_visible(
        ...
        self.title.to_have_text(title, nth=index)

        self.max_score_text.check_visible(nth=index)
        self.max_score_text.to_have_text(f'Max score: {max_score}', nth=index)

        self.min_score_text.check_visible(nth=index)
        self.min_score_text.to_have_text(f'Min score: {min_score}', nth=index)

        self.estimated_time.check_visible(nth=index)
        self.estimated_time.to_have_text(f'Estimated time: {estimated_time}', nth=index)
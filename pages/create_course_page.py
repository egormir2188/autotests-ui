...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_empty_course_description = page.get_by_test_id(
            'create-course-preview-empty-view-description-text'
        )
        self.preview_image = self.page.get_by_test_id('create-course-preview-image-upload-widget-preview-image')
        ...
        self.preview_image_upload_image_input = page.get_by_test_id(
    ...
    def check_visible_empty_exercises_form(self):
    ...
    def check_visible_create_exercise_form(self, index: int, title: str, description: str):
        ...
        exercise_title = self.page.get_by_test_id(f'create-course-exercise-{index}-box-toolbar-subtitle-text')
        ...
        expect(exercise_subtitle).to_have_text(f'#{index} Exercise')

...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.courses_empty_view_icon = page.get_by_test_id('courses-list-empty-view-icon')
        self.courses_empty_view_title = page.get_by_test_id('courses-list-empty-view-title-text')
        self.courses_empty_view_description = page.get_by_test_id(
    ...
    def check_visible_empty_view(self):
        expect(self.courses_empty_view_icon).to_be_visible()

        expect(self.courses_empty_view_title).to_be_visible()
        expect(self.courses_empty_view_title).to_have_text('There is no results')

        expect(self.courses_empty_view_description).to_be_visible()
        expect(self.courses_empty_view_description).to_have_text(
